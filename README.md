...
Estou sempre estudando e praticando para aprimorar minhas habilidades em programação e desenvolver projetos robustos, buscando aprender cada vez mais e transformar ideias em código.

A Ciência de Dados é apaixonante para mim por permitir usar dados para apoiar decisões e resolver problemas reais.

O Desenvolvimento Full Stack me atrai pela construção de aplicações completas. Gosto tanto da parte visual quanto da lógica por trás do sistema e de entender como tudo isso funciona junto.
...
I am always studying and practicing to improve my programming skills and develop robust projects, seeking to learn more and more and transform ideas into code.

Data Science is passionate to me because it allows us to use data to support decisions and solve real problems.

Full Stack Development attracts me by building complete applications. I like both the visual part and the logic behind the system and understanding how it all works together.
